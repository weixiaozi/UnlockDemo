...
public class GestureLockView extends View {
    ...
    //以下9种颜色均对外提供设置颜色的方法
    private  int OUT_CYCLE_NORMAL_COLOR =Color.parseColor("#ffd5dbe8"); // 外圆正常颜色
    private  int INNER_CYCLE_NORMAL_COLOR =Color.parseColor("#ffd5dbe8"); // 内圆正常颜色

    private  int LINE_NORMAL_COLOR = Color.parseColor("#ff508cee"); // 连接线颜色
    private  int OUT_CYCLE_CHOOSE_COLOR =Color.parseColor("#ff508cee");// 外圆选中颜色
    private  int INNER_CYCLE_CHOOSE_COLOR =Color.parseColor("#ff508cee"); // 内圆选中颜色

    private  int INNER_CYCLE_ERROR_COLOR = Color.parseColor("#ffff0000"); // 连接错误时内圆颜色
    private  int LINE_ERROR_COLOR = Color.parseColor("#66ff0000"); // 连接错误醒目提示颜色


    private  int INNER_CYCLE_DIY_COLOR =  Color.parseColor("#73d622"); // 自定义 释放后内圆的颜色
    private  int LINE_DIY_COLOR =  Color.parseColor("#6673d622"); //  自定义 释放后外圆和连线的颜色
